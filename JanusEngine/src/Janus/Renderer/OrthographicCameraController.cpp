...
namespace Janus {
	...
	void OrthographicCameraController::OnEvent(Event& e) {
		...
		dispatcher.Dispatch<MouseScrolledEvent>(JN_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(JN_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
